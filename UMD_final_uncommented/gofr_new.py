...
gofr_lib.compute_gofr.argtypes = (np.ctypeslib.ndpointer(dtype=np.int32, ndim=1,flags='C'),ctypes.POINTER(ctypes.c_double),ctypes.c_int,ctypes.POINTER(ctypes.c_int),ctypes.c_double,ctypes.POINTER(ctypes.c_double),ctypes.POINTER(ctypes.c_double),ctypes.c_int,ctypes.c_int)
gofr_lib.compute_gofr.restype = None
